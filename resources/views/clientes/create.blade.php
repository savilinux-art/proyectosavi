...
<div class="card">
    <div class="card-header">
        <h4><i class="bi bi-person-plus"></i> Nuevo Cliente</h4>
    </div>
    <div class="card-body">
        <form action="{{ route('clientes.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    @enderror
                    <small class="text-muted">13 caracteres (Persona Física o Moral)</small>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('regimen_fiscal') is-invalid @enderror" 
                        ...
                        <option value="Persona Física" {{ old('regimen_fiscal') == 'Persona Física' ? 'selected' : '' }}>Persona Física</option>
                        <option value="Persona Moral" {{ old('regimen_fiscal') == 'Persona Moral' ? 'selected' : '' }}>Persona Moral</option>
                        <option value="RESICO" {{ old('regimen_fiscal') == 'RESICO' ? 'selected' : '' }}>RESICO</option>
                    </select>

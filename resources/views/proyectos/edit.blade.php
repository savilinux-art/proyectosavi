            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" 
                           id="ubicacion" name="ubicacion" value="{{ old('ubicacion', $proyecto->ubicacion) }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('credenciales') is-invalid @enderror" 
                           ...
                           value="{{ old('credenciales', $proyecto->credenciales) }}" 
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($proyecto->archivo_as_built)
                        <div class="alert alert-info">
                            <i class="bi bi-file-earmark"></i> Documento actual cargado
                        </div>
                    @endif
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    @if($proyecto->salida_inventario)
                        <div class="alert alert-info">
                            <i class="bi bi-file-earmark-excel"></i> Documento actual cargado
                        </div>
                    @endif
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($proyecto->devolucion_inventario)
                        <div class="alert alert-info">
                            <i class="bi bi-file-earmark-arrow-down"></i> Documento actual cargado
                        </div>
                    @endif
